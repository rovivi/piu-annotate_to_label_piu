...
MODEL_DIR = '/Users/rodrigo/dev/piu/piu-annotate_to_label_piu/artifacts/models/visss-mlx-v9-large-ft'
BASELINE  = '/Users/rodrigo/dev/piu/piu-annotate_to_label_piu/artifacts/benchmark_baseline_60.json'
OUTPUT   = '/Users/rodrigo/dev/piu/piu-annotate_to_label_piu/v9_ft_model_comparison_report.html'

# v9-large-ft model architecture (from train_config.json)
V9_CONFIG = {
    'd_model': 384,
    'n_heads': 8,
    'n_layers': 8,
    'ffn_dim': 1536,
    'input_dim': 28,  # updated for v9 model
}
...
def create_v8_model(model_dir: str):
    ...
    model = LimbSequenceTransformer(
        input_dim=V9_CONFIG['input_dim'],
        d_model=V9_CONFIG['d_model'],
        n_heads=V9_CONFIG['n_heads'],
        n_layers=V9_CONFIG['n_layers'],
        ffn_dim=V9_CONFIG['ffn_dim'],
    )
